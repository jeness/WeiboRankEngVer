...
CsvToHtmlTable = {
    init: function (options) {
      ...
      var csv_path = "data/"+topic+senti+"Rank.csv"
      console.log(csv_path);
      var el = options.element || "table-container";
      var allow_download = true;
      var csv_options = options.csv_options || {};
      //var datatables_options = {"paging": true,"language": {"url": "js/Chinese.json"}}; //language setting
      var datatables_options = {"paging": true};
      var custom_formatting = [[4, format_link]];//generate hyperlink at column no.5 (when index = 4)
      console.log(custom_formatting);
